...
<div class="mailed-action-buttons">
	<a href="?page=<?php echo MAILED_DOMAIN; ?>&action=export_csv&page=list" class="button action">Exportar CSV</a>
	<a href="?page=<?php echo MAILED_DOMAIN; ?>&action=export_excel&page=list" class="button action">Exportar Excel</a>
	<?php if(MailedMailchimp::is_mailchimp_intragrate_list_table_on()): ?>
	<a href="?page=<?php echo MAILED_DOMAIN; ?>&action=sync_mailchimp&page=list" class="button action">Sincronizar com MailChimp</a>
	<?php endif; ?>
</div>
<!-- <div class="clear"></div> -->
